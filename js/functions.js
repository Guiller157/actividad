...
function descuento() {
    ...
    if (kmanzanas > 2  && kmanzanas <= 5) {
    
        precio = (kmanzanas * valorm) ;
        descuentoP = precio * 0.10;
        pagoT = precio-descuentoP;
        alert("su total apagar con descuento  es: "+pagoT)
      } else if (kmanzanas > 5  && kmanzanas <= 10) {

        precio = (kmanzanas * valorm) ;
        descuentoP = precio * 0.15;
        pagoT = precio-descuentoP;
        alert("su total apagar con descuento  es: "+pagoT)

      }else if (kmanzanas > 10  && kmanzanas <= 30) {
        ...
        precio = (kmanzanas * valorm) ;
        alert("su total apagar es : "+precio+ " ya que no aplica el descuento")
      };
